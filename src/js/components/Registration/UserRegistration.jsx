          ...
          <div className='row'>
            ...
            <div className='col-6'>
              ...
              <div className='container' style={{ 'padding': '1em'}}>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-10">
                    <button type="button" className="btn text-white" style={{ "background-color": "rgb(128, 10, 10)"}}><strong>Log In</strong></button>
                  </div>
                </div> 
              </div>
            </div>
            <div className='col-6'>
              ...
              <div className='container' style={{ 'padding': '1em'}}>
                ...
                <div className="form-group row">
                  <label for="example-text-input" className="col-2 col-form-label">Full Name</label>
                  <div className="col-10">
                    <input className="form-control" type="text" id="" />
                  </div>
                </div>
                ...
                <div className="form-group row">
                  <label for="example-text-input" className="col-2 col-form-label">Default Address</label>
                  <div className="col-10">
                    <input className="form-control" type="text" id="" />
                  </div>
                </div>
                <div className="form-group row" >
                  <label for="termsAndConditions" className="col-2 col-form-label">Terms & Conditions</label>
                  <div className="col-10">
                ...
                <div className="form-group row">
                  <label for="example-text-input" className="col-2 col-form-label"></label>
                  <div className="col-10">
                    <button type="button" className="btn text-white" style={{ "background-color": "rgb(128, 10, 10)"}}><strong>Accept & Continue</strong></button>
                  </div>
                </div>
              </div>
            </div>
